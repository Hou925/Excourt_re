...
Page({
  ...
  getApplication(){
    wx.request({
      url: `${BASE_URL}/student/get_apply`,
      method: 'POST',
      data: {
  ...
  getPublish(){
    wx.request({
      url: `${BASE_URL}/student/get_publish`,
      method: 'POST',
      data: {
        my_id: this.data.student_id,
      },
  ...
  getApproval(){
    wx.request({
      url: `${BASE_URL}/student/get_request`,
      method: 'POST',
      data: {
        my_id: this.data.student_id,
      },
  ...
  revokeApplication: function(e) {
    wx.request({
      url: `${BASE_URL}/student/delete_apply`,
      method: 'POST',
      data: {
  ...
  revokePublication: function(e) {
    ...
    wx.request({
      url: `${BASE_URL}/student/delete_pub`,
      method: 'POST',
      data: {
        table_name: e.currentTarget.dataset.table,
        court_id:e.currentTarget.dataset.courtid,
  ...
  acceptRequest: function(e) {
    wx.request({
      url: `${BASE_URL}/student/update_req`,
      method: 'POST',
      data: {
        table_name: e.currentTarget.dataset.table,
        court_id:e.currentTarget.dataset.courtid,
