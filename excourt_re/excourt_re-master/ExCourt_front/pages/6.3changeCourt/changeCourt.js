...
Page({
  ...
  loadExCourtRequests: function() {
    ...
    wx.request({
      url: BASE_URL + '/exchangecourt/get_response_records_by_student',
      method: 'POST',
  ...
  acceptRequest: function(e) {
    ...
    wx.request({
      url: BASE_URL + '/exchangecourt/complete_exchange',  // 发送同意请求的API
      method: 'POST',
      data: { 
  ...
  rejectRequest: function(e) {
    ...
    wx.request({
      url: BASE_URL + '/exchangecourt/refuse',  // 发送拒绝请求的API
      method: 'POST',
      data: { 
        Exchange_uploader_court_id: exchange_uploader_court_id,
        Exchange_responser_court_id: exchange_responser_court_id,
